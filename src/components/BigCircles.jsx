    ...
    <div className="relative w-full h-screen bg-black overflow-hidden">
      ...
      >
        ...
        <div className="text-left space-y-4 mb-8">
          <p className="text-lg">
            This component showcases the{" "}
            <span className="text-blue-400 font-mono">bigCircles</span> preset
            from tsparticles, creating large, elegant circles that float across
            the screen.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>
                  Initialized with{" "}
                  <span className="font-mono">initParticlesEngine</span>
                </li>
        ...
        <div className="text-sm text-gray-300">
          <p>
            Part of the tsparticles library -{" "}
            <span className="text-white">https://particles.js.org/</span>
          </p>
          <p className="mt-1">
            Customize by editing the options in the component code
          </p>
        </div>
      </div>
    </div>
